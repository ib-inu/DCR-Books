    ...
    return (
        <main>
            ...
            <section className={styles.text} >
                ...
                <p>Welcome to the Contribute page! Your involvement can help make this platform an even better resource for book lovers everywhere. Whether you&apos;re a developer, an avid reader, or someone with a keen eye for detail, your contributions are invaluable. Here’s how you can get involved:</p>
                <hr />
                <h2>Ways to Contribute</h2>
                <h3>1, Provide Feedback</h3>
                <p>Your feedback helps shape the future of this platform. If you have suggestions for improving the user experience, design, or content, I’d love to hear them!</p>



                <h3>2, Suggest Features</h3>
                <p>Do you have an idea for a new feature or tool that would make this site more useful? Share your thoughts, and together we can explore how to bring them to life.</p>
                ...
                <p>Feel free to reach out through the  <a href="mailto:ibnumuhthar9@gmail.com">
                    email
                </a>. Whether it’s feedback, a suggestion, or an idea for collaboration, I’m eager to hear from you.</p>
                <h3>GitHub <i className="fa-brands fa-github"></i></h3>
                <p>
                    If you&apos;re a developer and would like to contribute code or documentation, you can check out the <a href="#">GitHub</a> repository. Your contributions to the codebase are welcome and appreciated!
                    <br />
                    feel free to redesign too :)
                </p>
                <hr />
                ...
                <p>Please ensure that all contributions are respectful and constructive. Together, we can maintain a positive and welcoming environment for all members of the community.</p>
                <br />
