    ...
    return (
        <main>
            ...
            <section className={styles.text}>
                ...
                <p>In a world filled with countless books and stories, keeping track of your reading journey can be both challenging and rewarding. This website was created with the simple purpose of helping book lovers like you to organize and reflect on the books you&apos;ve read and the ones that hold a special place in your heart.</p>
                <br />
                <br />
                <br />
                <br />
                ...
                <p>This website also serves as a personal project to hone skills in web development, particularly in using React Router for navigation. While simple in design, it’s built with care and attention to detail, reflecting the desire to create a professional and user-friendly experience. </p>
                <br />
                <br />
                <br />
                <br />
