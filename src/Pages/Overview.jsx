    ...
    return (
        <main>
            ...
            <section>
                ...
                <p className={styles.details}>
                    Ready to dive in? Start tracking your books today and see how easy it is to organize your literary adventures with BookTracker. Explore our features, and you&apos;ll never lose track of your reading journey again. <br />
                    <button
