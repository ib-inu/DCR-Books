        ...
        <main>
            <section className={styles.text}>
                ...
                <AnimatedSection direction="right">
                    ...
                    <p>
                        If you&apos;re a developer and would like to contribute code or documentation, you can check out the <a href="#">GitHub</a> repository. Your contributions to the codebase are welcome and appreciated! Feel free to make good design too :)
                    </p>
                </AnimatedSection>
                ...
                <AnimatedSection direction="top">
                    ...
                    <p>
                        Please ensure that all contributions are respectful and constructive. Together, we can maintain a positive and welcoming environment for all members of the community. <br />
                        I’m excited to see how we can build and improve this platform together. Thank you!</p>
                </AnimatedSection>
            </section>
